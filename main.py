...
def convert():
    ...
    try:
        ...
        first_currency = currency_in.get() 
        #name of the second currency   
        last_currency = currency_out.get()        
...
# Currency Frame
convert_frame = Frame(gui, width=480, height=480, bg='#5E5E5E')
convert_frame.pack(fill="both", expand=1)

# Conversion Frame
add_currency_frame = Frame(gui, width=480, height=480, bg='#5E5E5E')
add_currency_frame.pack(fill="both", expand=1)

# Historic Frame
historic_frame = Frame(gui, width=480, height=480, bg='#5E5E5E')
...
#Create my TOP Frame
amount_L_frame = LabelFrame(convert_frame , text="Amount to convert", font=DEFAULT_FONT_STYLE, bg='#5E5E5E')
...
currencies_L_frame = LabelFrame(convert_frame, text="Currencies to convert", font=DEFAULT_FONT_STYLE, bg='#5E5E5E')
...
result_L_frame = LabelFrame(convert_frame, text="Result : ", font=DEFAULT_FONT_STYLE, bg='#5E5E5E')
